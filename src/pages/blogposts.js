...
const mockdata = [
  {
    ...
    description:
      "Relationship experience material community class person position speech method himself own economic low in boy.",
  ...
  },
  {
    ...
    description:
      "Deal political west scientist different customer her thank design what stop project set poor measure according history true wear option.",
    title: "Rodgers Inc",
    interactions: 530,
  },
  {
    ...
    description:
      "Grow police tough section start cold interesting pull happy meet wear sound apply throughout risk hold.",
    title: "Green-Moon",
    post: "blabh blah blah",
    interactions: 308,
  },
        ...
        <Container maxWidth="xl">
          <Stack spacing={3}>
            <Stack direction="row" justifyContent="space-between" spacing={4}>
              <Stack spacing={1}>
                <Typography variant="h4">Blogposts</Typography>
              </Stack>
              <div>
                <Button
                  startIcon={
            ...
            <Grid container spacing={3}>
              {visiblePosts.map((blogpost) => (
                <Grid xs={12} md={6} lg={4} key={blogpost.id}>
